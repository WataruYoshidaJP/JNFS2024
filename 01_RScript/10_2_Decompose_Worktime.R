...
## 4) Never-married vs. Married (Working Time) ----
...
decomp4 <- oaxaca(formula = WorkTimeWeekFemale ~ SchoolGrd6GrpFemale_JH + SchoolGrd6GrpFemale_Voc + SchoolGrd6GrpFemale_JC + SchoolGrd6GrpFemale_Univ + SchoolGrd6GrpFemale_Gra + CAgeSvyW + YearSvy
...
PLOT <- 
  ...
  plot(components = c("endowments", "coefficients"),
       ...
       title = " Never married vs. Married: Working time per week")
print(PLOT)

ggsave(plot     = PLOT,
       filename = paste0(OutDir, "Decompostion/WorkTimeWeek_Decompose_marriage.png"),
       device   = "png",
       width    = 10,
       height   = 7,
       dpi      = 600)
...
## 5) Married w/o children vs. Married w/ children (Working Time) ----
...
decomp5 <- oaxaca(formula = WorkTimeWeekFemale ~ SchoolGrd6GrpFemale_JH + SchoolGrd6GrpFemale_Voc + SchoolGrd6GrpFemale_JC + SchoolGrd6GrpFemale_Univ + SchoolGrd6GrpFemale_Gra + CAgeSvyW + YearSvy
                    + JobStatSvyFemale_Reg + JobStatSvyFemale_Part + JobStatSvyFemale_Self + JobYearsSvyFemale
                    + JobTypeSvyFemale_Self + JobTypeSvyFemale_Pro + JobTypeSvyFemale_Mgr + JobTypeSvyFemale_Cler + JobTypeSvyFemale_Fac
                    + JobSizeSvyFemale_3099 + JobSizeSvyFemale_100299 + JobSizeSvyFemale_300999 + JobSizeSvyFemale_1000 + JobSizeSvyFemale_Pub
...
PLOT <- 
  ...
  plot(components = c("endowments", "coefficients"),
       ...
       variable.labels = c("SchoolGrd6GrpFemale_JH" = "Educational Attainment: Junior high", 
                           ...
                           "JobSizeSvyFemale_1000" = "1000+",
                           "JobSizeSvyFemale_Pub" = "Public"),
       title = " Married w/o children vs. Married w/ children: Working time per week ")
print(PLOT)

ggsave(plot     = PLOT,
       filename = paste0(OutDir, "Decompostion/WorkTimeWeek_Decompose_children_in_marriage.png"),
       device   = "png",
       width    = 10,
       height   = 7,
       dpi      = 600)
