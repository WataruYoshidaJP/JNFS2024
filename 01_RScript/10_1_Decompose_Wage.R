...
## 1) Never-married vs. Married ----

DF_decomp <-
  DF_use |> 
  filter(Decomp3Grp %in% c("Never married", "Married w/o children", "Married w/ children"))

decomp1 <- oaxaca(formula = LogWageW ~ SchoolGrd6GrpFemale_JH + SchoolGrd6GrpFemale_Voc + SchoolGrd6GrpFemale_JC + SchoolGrd6GrpFemale_Univ + SchoolGrd6GrpFemale_Gra + CAgeSvyW + YearSvy
...
PLOT <- 
  ...
  plot(components = c("endowments", "coefficients"),
       ...
       title = " Never married vs. Married : Wage ")
print(PLOT)

ggsave(plot     = PLOT,
       filename = paste0(OutDir, "Decompostion/Wage_Decompose_marriage.png"),
       device   = "png",
       width    = 10,
       height   = 7,
       dpi      = 600)
...
## 2) Married w/o children vs. Married w/ children ----
...
decomp2 <- oaxaca(formula = LogWageW ~ SchoolGrd6GrpFemale_JH + SchoolGrd6GrpFemale_Voc + SchoolGrd6GrpFemale_JC + SchoolGrd6GrpFemale_Univ + SchoolGrd6GrpFemale_Gra + CAgeSvyW + YearSvy
                    + JobStatSvyFemale_Reg + JobStatSvyFemale_Part + JobStatSvyFemale_Self + JobYearsSvyFemale
                    + JobTypeSvyFemale_Self + JobTypeSvyFemale_Pro + JobTypeSvyFemale_Mgr + JobTypeSvyFemale_Cler + JobTypeSvyFemale_Fac
                    + JobSizeSvyFemale_3099 + JobSizeSvyFemale_100299 + JobSizeSvyFemale_300999 + JobSizeSvyFemale_1000 + JobSizeSvyFemale_Pub
...
PLOT <- 
  ...
  plot(components = c("endowments", "coefficients"),
       ...
       variable.labels = c("SchoolGrd6GrpFemale_JH" = "Educational Attainment: Junior high", 
                           ...
                           "JobSizeSvyFemale_1000" = "1000+",
                           "JobSizeSvyFemale_Pub" = "Public"),
       title = " Married w/o children vs. Married w/ children: Wage")
print(PLOT)

ggsave(plot     = PLOT,
       filename = paste0(OutDir, "Decompostion/Wage_Decompose_children_in_marriage.png"),
       device   = "png",
       width    = 10,
       height   = 7,
       dpi      = 600)
...
## 3) Never-married vs. Married w/o children ----

DF_decomp <-
  DF_use |> 
  filter(Decomp3Grp %in% c("Never married", "Married w/o children"))


decomp3 <- oaxaca(formula = LogWageW ~ SchoolGrd6GrpFemale_JH + SchoolGrd6GrpFemale_Voc + SchoolGrd6GrpFemale_JC + SchoolGrd6GrpFemale_Univ + SchoolGrd6GrpFemale_Gra + CAgeSvyW + YearSvy
                    + JobStatSvyFemale_Reg + JobStatSvyFemale_Part + JobStatSvyFemale_Self + JobYearsSvyFemale
                    + JobTypeSvyFemale_Self + JobTypeSvyFemale_Pro + JobTypeSvyFemale_Mgr + JobTypeSvyFemale_Cler + JobTypeSvyFemale_Fac
                    + JobSizeSvyFemale_3099 + JobSizeSvyFemale_100299 + JobSizeSvyFemale_300999 + JobSizeSvyFemale_1000 + JobSizeSvyFemale_Pub
                    | Decomp2Grp_marry_without_child | SchoolGrd6GrpFemale_JH + SchoolGrd6GrpFemale_Voc + SchoolGrd6GrpFemale_JC + SchoolGrd6GrpFemale_Univ + SchoolGrd6GrpFemale_Gra, data = DF_decomp, R = 1000)
...
PLOT <- 
  ...
  plot(components = c("endowments", "coefficients"),
       ...
       variable.labels = c("SchoolGrd6GrpFemale_JH" = "Educational Attainment: Junior high", 
                           ...
                           "JobSizeSvyFemale_1000" = "1000+",
                           "JobSizeSvyFemale_Pub" = "Public"),
       title = " Never married vs. Married w/o children: Wage")
print(PLOT)

ggsave(plot     = PLOT,
       filename = paste0(OutDir, "Decompostion/Wage_Decompose_marriage_without_children.png"),
       device   = "png",
       width    = 10,
       height   = 7,
       dpi      = 600)
